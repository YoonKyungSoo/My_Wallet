...
public class CommentReportDtos {
  ...
  public record AdminRow(
      long id, String commentId, String reason, String status, String createdAt, String updatedAt) {}

  public record UpdateStatusRequest(@NotBlank String status) {}

  public static AdminRow toRow(
      long id, String commentId, String reason, String status, LocalDateTime createdAt, LocalDateTime updatedAt) {
    return new AdminRow(
        id,
        commentId,
        reason,
